...
public class MethodsSortArray {



    public static void bubbleSortUp(int[] arrayInt) {
    ...
    public static void bubbleSortDown(int[] arrayInt) {
        int length = arrayInt.length;
        int temp = 0;
        for (int i = 0; i < length; i++) {
    ...
    public static void nativeJavaArraysSort(int[] arrayInt) {
        Arrays.sort(arrayInt);
    }



    public static void sortMerge(int[] arrayInt) {
        int length = arrayInt.length;
        int n = 1;
        int shift;
        int two_size;
    ...
    public static void sortSelection (int[] arrayInt){
        int min, temp;
